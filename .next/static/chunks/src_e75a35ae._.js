...
const Logo = (param)=>{
    ...
    if (showFallback) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "".concat(container, " rounded-full bg-gradient-to-br from-yellow-400 to-yellow-500 text-gray-900 shadow-lg flex items-center justify-center font-bold ").concat(text, " ").concat(className, " border-2 border-white ring-2 ring-yellow-200"),
            children: "FA"
        }, void 0, false, {
...
//# sourceMappingURL=src_e75a35ae._.js.map